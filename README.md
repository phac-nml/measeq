...
Changes in `v1.2.0` include the addition of [Bowtie 2](https://github.com/BenLangmead/bowtie2) as an optional tool to map reads to their reference files and support for the [Artic primers](https://www.biorxiv.org/content/10.1101/2024.12.20.629611v1) through a nextflow profile.
