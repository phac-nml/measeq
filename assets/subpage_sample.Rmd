...
> if they are above the set minimum depth. The dashed line represents the threshold at which a variant is confidently called.
...
if (file.exists(var_f)) {
  ...
  ddt <- variants %>%
    datatable(rownames = FALSE,
      caption = htmltools::tags$caption(
        style = 'caption-side: top',
        htmltools::strong('Table III: '), 'Consensus Variant Summary Table. VCF-based summary table of the variants found in the final consensus sequence. The "Type" column displaying more information on what the base is in the final sequence and any other notes on it.'
      ),
      options = list(
        pageLength = 10,
        scrollX = FALSE,
