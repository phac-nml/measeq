...
final_shapes <- c(gene_shapes_normal, list(hline(75)))
...
> All positions with >=8 reads, a positional read base quality of >=12 and a map quality >=30 were included in the analysis.
...
> if they are above the set minimum depth.
