...
# Initialize gene rectangles for plots
...
p <- p %>% add_text(
  x = gene_label_loc,
  y = rep(-6.5, length(gene_label_loc)),
  text = gene_label,
...
depthp <- depthp %>% add_text(
  x = gene_label_loc,
  y = rep(0.55, length(gene_label_loc)),
  text = gene_label,
  inherit = FALSE,
  type = "scatter",
  mode = "text",
